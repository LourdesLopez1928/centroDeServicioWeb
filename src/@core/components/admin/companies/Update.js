...
const FormUpdateCompany = ({ company, closeModal }) => {
  ...
  const [formData, setFormData] = useReducer(formReducer, company)
  ...
  const handleSubmit = async event => {
    ...
    const { status } = await companyService.update(formData._id, params, sessionStorage.getItem('token'))
  ...
  return (
    <>
      <Card>
        ...
        <CardHeader
          title={<FormattedMessage id='update-company' defaultMessage='Update' />}
